 ...
 */
public class revenuReport extends javax.swing.JDialog {
     ...
     */
    public revenuReport(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//                    parameters.put("REPORT_MONTHLY_TOTAL", monthlyTotal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(revenuReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                revenuReport dialog = new revenuReport(new javax.swing.JFrame(), true);
