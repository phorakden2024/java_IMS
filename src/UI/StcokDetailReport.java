 ...
 */
public class StcokDetailReport extends javax.swing.JDialog {
     ...
     */
    public StcokDetailReport(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnperviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnperviewActionPerformed
        ...
        if (this.CheckBox_DTD.getModel().isSelected()) {
            try {
                ...
                InputStream jrxmlStream = StcokDetailReport.class.getClassLoader().getResourceAsStream("Reports/exspensesReportStartEnd.jrxml");
        ...
        if (this.CheckBox_GR.getModel().isSelected()) {
            try {
                ...
                switch (this.cboReportFormat.getSelectedIndex()) {
                    case 0 -> {
                        // 2. Load JRXML report file from classpath
                        InputStream jrxmlStream = Invoices_list.class.getClassLoader().getResourceAsStream("Reports/MothlyStockDetailReport.jrxml");

                        if (jrxmlStream == null) {
                            throw new JRException("MothlyStockDetailReport.jrxml not found. Ensure it's in src/Reports and properly added to the classpath.");
                        }
                        // 3. Compile the JRXML to JasperReport
                        JasperReport jasperReport = JasperCompileManager.compileReport(jrxmlStream);
                        System.out.println("JRXML compiled successfully.");
                        // 4. Set report parameters
                        Map<String, Object> parameters = new HashMap<>();
                        parameters.put("REPORT_TITLE", "All Income Report");
...
//                    parameters.put("REPORT_MONTHLY_TOTAL", monthlyTotal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StcokDetailReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                StcokDetailReport dialog = new StcokDetailReport(new javax.swing.JFrame(), true);
