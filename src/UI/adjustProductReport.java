 ...
 */
public class adjustProductReport extends javax.swing.JDialog {
     ...
     */
    public adjustProductReport(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        });
    ...
    private void initComponents() {
        ...
        cboReportFormat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Monthly Report", "All Report" }));
    ...
    private void btnperviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnperviewActionPerformed
        ...
        if (this.CheckBox_DTD.getModel().isSelected()) {
            try {
                ...
                InputStream jrxmlStream = productReport.class.getClassLoader().getResourceAsStream("Reports/AdjuetStockDTDReport.jrxml");

                if (jrxmlStream == null) {
                    throw new JRException("AllProductReport.jrxml not found. Ensure it's in src/Reports and properly added to the classpath.");
                }
                ...
                parameters.put("REPORT_TITLE", "Adjust Report");
        ...
        if (this.CheckBox_GR.getModel().isSelected()) {
            try {
                ...
                switch (this.cboReportFormat.getSelectedIndex()) {
                    case 0 -> {
                        // 2. Load JRXML report file from classpath
                        InputStream jrxmlStream = Invoices_list.class.getClassLoader().getResourceAsStream("Reports/MonthlyAdjuetReport.jrxml");

                        if (jrxmlStream == null) {
                            throw new JRException("MonthlyAdjuetReport.jrxml not found. Ensure it's in src/Reports and properly added to the classpath.");
                        }
                        // 3. Compile the JRXML to JasperReport
                        JasperReport jasperReport = JasperCompileManager.compileReport(jrxmlStream);
                        System.out.println("JRXML compiled successfully.");
                        // 4. Set report parameters
                        Map<String, Object> parameters = new HashMap<>();
                        parameters.put("REPORT_TITLE", "Adjust Product List Report");
...
//                    parameters.put("REPORT_MONTHLY_TOTAL", monthlyTotal);
                    ...
                    case 1 -> {
                        // 2. Load JRXML report file from classpath
                        InputStream jrxmlStream = Invoices_list.class.getClassLoader().getResourceAsStream("Reports/AllAdjuetReport.jrxml");

                        if (jrxmlStream == null) {
                            throw new JRException("AllAdjuetReport.jrxml found. Ensure it's in src/Reports and properly added to the classpath.");
                        }
                        // 3. Compile the JRXML to JasperReport
                        JasperReport jasperReport = JasperCompileManager.compileReport(jrxmlStream);
                        System.out.println("JRXML compiled successfully.");
                        // 4. Set report parameters
                        Map<String, Object> parameters = new HashMap<>();
                        parameters.put("REPORT_TITLE", "Adjust Product List Report All Data");
//                    LocalDate today = LocalDate.now();
//                    LocalDate startOfMonth = today.with(TemporalAdjusters.firstDayOfMonth());
//                    LocalDate endOfMonth = today.with(TemporalAdjusters.lastDayOfMonth());
//                    LocalDate startOfMonth = LocalDate.of(2025, 7, 1);
...
//                    parameters.put("REPORT_MONTHLY_TOTAL", monthlyTotal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adjustProductReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                adjustProductReport dialog = new adjustProductReport(new javax.swing.JFrame(), true);
