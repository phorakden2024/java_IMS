 ...
 */
public class incomeReport extends javax.swing.JDialog {
     ...
     */
    public incomeReport(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnperviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnperviewActionPerformed
        ...
        if (this.CheckBox_DTD.getModel().isSelected()) {
            try {
                ...
                InputStream jrxmlStream = incomeReport.class.getClassLoader().getResourceAsStream("Reports/exspensesReportStartEnd.jrxml");
...
//                        doClose(returnStatus);
                    ...
                    case 1 -> {
                        // 2. Load JRXML report file from classpath
                        InputStream jrxmlStream = Invoices_list.class.getClassLoader().getResourceAsStream("Reports/MothlyIncomeReport.jrxml");

                        if (jrxmlStream == null) {
                            throw new JRException("MothlyIncomeReport.jrxml not found. Ensure it's in src/Reports and properly added to the classpath.");
                        }
                        // 3. Compile the JRXML to JasperReport
                        JasperReport jasperReport = JasperCompileManager.compileReport(jrxmlStream);
                        System.out.println("JRXML compiled successfully.");
...
//                        parameters.put("REPORT_MONTHLY_TOTAL", monthlyTotal);
                    ...
                    case 2 -> {
                        // 2. Load JRXML report file from classpath
                        InputStream jrxmlStream = Invoices_list.class.getClassLoader().getResourceAsStream("Reports/ALLIncomeReport.jrxml");

                        if (jrxmlStream == null) {
                            throw new JRException("ALLIncomeReport.jrxml not found. Ensure it's in src/Reports and properly added to the classpath.");
                        }
                        // 3. Compile the JRXML to JasperReport
                        JasperReport jasperReport = JasperCompileManager.compileReport(jrxmlStream);
                        System.out.println("JRXML compiled successfully.");
...
//                    parameters.put("REPORT_MONTHLY_TOTAL", monthlyTotal);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                incomeReport dialog = new incomeReport(new javax.swing.JFrame(), true);
