 ...
 */
public class importProductReport extends javax.swing.JDialog {
     ...
     */
    public importProductReport(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        });
    ...
    private void initComponents() {
        ...
        cboReportFormat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "All Report" }));
...
//                InputStream jrxmlStream = productReport.class.getClassLoader().getResourceAsStream("Reports/AllProductReport.jrxml");
//
//                if (jrxmlStream == null) {
...
//                parameters.put("REPORT_TITLE", "ALL PRODUCT Report");
        ...
        if (this.CheckBox_GR.getModel().isSelected()) {
            try {
                ...
                switch (this.cboReportFormat.getSelectedIndex()) {
                    case 0 -> {
                        // 2. Load JRXML report file from classpath
                        InputStream jrxmlStream = Invoices_list.class.getClassLoader().getResourceAsStream("Reports/AllImportProductReport.jrxml");

                        if (jrxmlStream == null) {
                            throw new JRException("AllImportProductReport.jrxml not found. Ensure it's in src/Reports and properly added to the classpath.");
                        }
                        // 3. Compile the JRXML to JasperReport
                        JasperReport jasperReport = JasperCompileManager.compileReport(jrxmlStream);
                        System.out.println("JRXML compiled successfully.");
                        // 4. Set report parameters
                        Map<String, Object> parameters = new HashMap<>();
                        parameters.put("REPORT_TITLE", "Import Product List Report");
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(importProductReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                importProductReport dialog = new importProductReport(new javax.swing.JFrame(), true);
